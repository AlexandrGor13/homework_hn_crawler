...
from crawler.settings import base_url
...
class HNParser:
    ...
    def _parse_news_row(self, row) -> Optional[NewsItem]:
        """Парсинг одной строчки новостей."""
        try:
    ...
    def parse_news_page(self, html: str) -> List[NewsItem]:
        """Извлекает все новости с домашней страницы HN."""
    ...
    def parse_comment_links(self, html: str) -> List[str]:
        """Извлекает все внешние ссылки из комментариев."""
        soup = BeautifulSoup(html, 'lxml')
        links = []
